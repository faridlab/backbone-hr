...
/// Create stateless routes for the Hr module.
///
...
///
/// ```ignore
/// let module = HrModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::HrModule) -> Router<()> {
    Router::new()
        .merge(create_attendance_routes(module.attendance_service.clone()))
...
pub fn get_routes(module: &crate::HrModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Hr module.
///
...
pub fn create_combined_routes(module: &crate::HrModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Hr module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::HrModule) -> Router<AppState> {
    Router::new()
