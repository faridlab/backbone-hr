//! Specifications for LeaveType aggregate
//!
...
// Each predicate implements `Specification<LeaveType>` and can be combined
...
//
// pub struct ActiveLeaveTypeSpec;
// impl Specification<LeaveType> for ActiveLeaveTypeSpec {
//     fn is_satisfied_by(&self, e: &LeaveType) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
