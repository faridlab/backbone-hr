//! Specifications for LeaveBalance aggregate
//!
...
// Each predicate implements `Specification<LeaveBalance>` and can be combined
...
//
// pub struct ActiveLeaveBalanceSpec;
// impl Specification<LeaveBalance> for ActiveLeaveBalanceSpec {
//     fn is_satisfied_by(&self, e: &LeaveBalance) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
