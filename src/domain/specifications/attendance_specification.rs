//! Specifications for Attendance aggregate
//!
...
// Each predicate implements `Specification<Attendance>` and can be combined
...
//
// pub struct ActiveAttendanceSpec;
// impl Specification<Attendance> for ActiveAttendanceSpec {
//     fn is_satisfied_by(&self, e: &Attendance) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
